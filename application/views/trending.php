...
<!-- ======= OUR TRENDING ======= -->
<h3 style="color: #313550; padding-top: 150px;padding-bottom: 10px; margin-left: 10px">TRENDING</h3>
...
<div class="row row-cols-1 row-cols-md-4 g-4" style="margin-left: 20px; margin-right:20px">
    ...
    <div class="col" style=" padding-top:20px">
        <div class="card h-100">
            <div class="card2">
                <img src="https://drive.google.com/uc?id=1NQUilwcqj2I2vWO7FiDi4OcAE2D05bct" class="card-img-top">
            </div>
            <div class="card-body">
                <h4 class="card-title">S A M S U N G</h4>
                <p class="card-text">Samsung Galaxy S21 Ultra</p>
                <p class="card-text"><small class="text-muted">Best cameras, great battery life, and design</small></p>
            </div>
        </div>
    </div>
    ...
    <div class="col" style=" padding-top:20px">
        <div class="card h-100">
            <div class="card2">
                <img src="https://drive.google.com/uc?id=1NroKmrZzIfVbRS6WKtbKQ0hp0V0PBRre" class="card-img-top">
            </div>
            <div class="card-body">
                <h4 class="card-title">APPLE</h4>
                <p class="card-text">IPHONE 13 Pro/ Iphone 13 Pro Max </p>
                <p class="card-text"><small class="text-muted">Great performance, Strong battery life</small></p>
            </div>
        </div>
    </div>
    ...
    <div class="col" style=" padding-top:20px">
        <div class="card h-100">
            <div class="card2">
                <img src="https://drive.google.com/uc?id=1NQnBOA_ZEZXVZ8vQ4ZEtZHH3L7zSx8NN" class="card-img-top">
            </div>
            <div class="card-body">
                <h4 class="card-title">XIAOMI</h4>
                <p class="card-text">Xiaomi Mi 11</p>
                <p class="card-text"><small class="text-muted">Great photography, Fast performance</small></p>
            </div>
        </div>
    </div>
    ...
    <div class="col" style=" padding-top:20px">
        <div class="card h-100">
            <div class="card2">
                <img src="https://drive.google.com/uc?id=10bt44dwdNqlFAO2ypKOikMA9GSy6s_rY" class="card-img-top">
            </div>
            <div class="card-body">
                <h4 class="card-title">ASUS</h4>
                <p class="card-text">ASUS VIVOBOOK 14X PRO OLED</p>
                <p class="card-text"><small class="text-muted">ASUS Vivobook Pro 14X OLED
                        Ignite your creativity</small></p>
            </div>
        </div>
    </div>
    <div class="col" style=" padding-top:20px">
